...
import type { BatchMLPrediction, FeatureVector, MLPrediction } from '../../../src/ml/types';
...
describe('Prediction Utilities', () => {
  ...
  describe('getTopFeatures', () => {
    ...
    it('should handle N larger than array', () => {
      const importance = [{ name: 'f1', value: 1, contribution: 0.5, importance: 0.5 }];
  ...
  describe('formatPrediction', () => {
    it('should format prediction as human-readable string', () => {
      const prediction: MLPrediction = {
        ...
        featureImportance: [
          { name: 'emailSimilarity', value: 0.9, contribution: 0.45, importance: 0.45 },
        ],
      };
  ...
  describe('createLabeledPair', () => {
    it('should create a labeled pair', () => {
      const pair = createLabeledPair({ name: 'John' }, { name: 'John' }, 'match');
  ...
  describe('mergeFeatureVectors', () => {
    ...
    it('should merge metadata', () => {
      const v1: FeatureVector = { values: [0.9], names: ['f1'], metadata: { source: 'a' } };
      const v2: FeatureVector = { values: [0.8], names: ['f2'], metadata: { type: 'b' } };
