...
describe('Performance: Blocking Strategies', () => {
  ...
  it('should generate standard blocks for 10k records in <20ms', () => {
  ...
  it('should generate composite blocks efficiently', () => {
    ...
    const start = performance.now()
    const compositeBlocks = blockGen.generateBlocksComposite(
      records,
      [strategy1, strategy2]
    )
    const duration = performance.now() - start
  ...
  it('should efficiently calculate blocking statistics', () => {
    ...
    console.log(`Blocking stats calculation: ${duration.toFixed(2)}ms, reduction: ${stats.reductionPercentage.toFixed(2)}%`)
  })
  ...
  it.skip('should generate pairs efficiently', () => {
    ...
    console.log(`Pair generation from 1k records: ${duration.toFixed(2)}ms, ${pairs.length} pairs`)
  })
  ...
  it.skip('should not degrade with repeated blocking operations', () => {
    ...
    console.log(`Blocking degradation: ${degradation.toFixed(2)}% (first: ${firstAvg.toFixed(2)}ms, last: ${lastAvg.toFixed(2)}ms)`)
  })
})
