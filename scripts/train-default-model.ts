...
const firstNames = [
  'John', 'Jane', 'Michael', 'Sarah', 'Robert', 'Emily', 'David', 'Emma',
  'James', 'Olivia', 'William', 'Sophia', 'Richard', 'Isabella', 'Thomas',
];
...
function randomAddress(): string {
  ...
  const streets = ['Main St', 'Oak Ave', 'Elm St', 'Park Rd', 'First St', 'Second Ave'];
...
function generateTrainingData(
  ...
  console.log(`Generating ${matchCount} match pairs and ${nonMatchCount} non-match pairs...`);
...
async function main() {
  ...
  console.log('Note: The weights in src/ml/builtin/weights.json were trained using');
